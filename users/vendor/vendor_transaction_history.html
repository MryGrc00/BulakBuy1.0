    ...
    <body>
                    ...
                    <ul class="navbar-nav dib">
                        <li class="nav-item">
                            <form class="form-inline my-2 my-lg-0">
                                ...
                                <a href="#" id="back-link"><i class="back fa fa-angle-left" aria-hidden="true"></i></a>
                    ...
                    <div class="transaction-details">
                        ...
                        <div class="text-content">
                            <div class="transact">
                                ...
                                <span class="transaction-price">₱ 3,000</span>
                            </div>
                            <div class="status">
                                <span class="transaction-description">From Niña Mae Cabilao</span>
                                <span class="transact-status">Successful</span>
                            </div>
                            <div class="o-date-time">
                                <span class="transaction-date">23 July 2023</span>
                                <span class="transaction-time">7:20 AM</span>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                // Get the back-link element by its id.
                var backLink = document.getElementById("back-link");
            
                // Set the href attribute based on the user type.
                if (userType === "seller") {
                    backLink.href = "seller_home.html";
                } else if (userType === "arranger") {
                    backLink.href = "arranger_home.html";
                } else {
                    backLink.href = "vendor_home.html";
                }
            });
        </script>
    </body>
